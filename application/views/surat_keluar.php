        ...
        foreach($user as $key){ 
          ...
          <tr style="background-color:#dfe1e2; color:black;">
            ...
            <td style="text-align: center;">
             <a href="<?php echo base_url(); ?>admin/surat_keluar/update/<?php echo $key->id ?>" class="btn btn-info btn-warning btn-xs">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="alert alert-info" id="exampleModalLabel"><h3 align="center">Data Surat keluar</h3></div>

        </div>
        <div class="modal-body">
          <div class="form-group">
            <form action="<?php echo base_url(); ?>surat_keluar/action_add" method="post">
