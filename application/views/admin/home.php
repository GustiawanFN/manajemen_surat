  ...
  <div class="row">
    <div class="col-lg-4 col-xs-6">
      ...
      <div class="small-box bg-aqua">
        ...
        <a href="<?php echo site_url('surat_masuk') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-4 col-xs-6">
      ...
      <div class="small-box bg-green">
        ...
        <a href="<?php echo site_url('surat_keluar') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
    <div class="col-lg-4 col-xs-6">
      ...
      <div class="small-box bg-yellow">
        ...
        <a href="<?php echo site_url('buku_tamu') ?>" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
  </div>
