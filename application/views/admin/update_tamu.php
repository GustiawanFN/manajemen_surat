 ...
 <div class="box">
  ...
  <div class="box-body">
    <?php foreach ($content->result() as $key): ?>
      <form action="<?php echo base_url(); ?>buku_tamu/action_update/<?php echo $key->id ?>" method="post">
        <input type="hidden" name="id" value="<?php echo $key->id ?>">
        <div class="box-body">
          <div class="form-group">
            <label for="exampleInputEmail1">Tanggal</label>
            <input type="text" class="form-control" name="tanggal" autocomplete="off"  value="<?php echo $key->tanggal ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Nama</label>
            <input type="text" class="form-control" name="nama_tamu" autocomplete="off" value="<?php echo $key->nama_tamu ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Pekerjaan</label>
            <input type="text" class="form-control" name="pekerjaan_tamu" autocomplete="off" value="<?php echo $key->pekerjaan_tamu ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Alamat</label>
            <input type="text" class="form-control" name="alamat_tamu" autocomplete="off" value="<?php echo $key->alamat_tamu ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Keperluan</label>
            <input type="text" class="form-control" name="keperluan" autocomplete="off" value="<?php echo $key->keperluan ?>">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Saran dan Harapan</label>
            <input type="text" class="form-control" name="saran_tamu" autocomplete="off" value="<?php echo $key->saran_tamu ?>">
          </div>
