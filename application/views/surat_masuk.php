    ...
    <thead>
      <tr>
        <td colspan="3" style="padding-left:0px;">
          <form class="navbar-form" action="<?php echo base_url('surat_masuk/hasil')?>" role="search" style="padding-left:0px;">
      ...
      if(count($user)>0)
      {
        foreach($user as $key){ 
          ...
          <tr style="background-color:#dfe1e2; color:black;">
            ...
            <td style="text-align: center;"><?php echo "Dokumen" ?></td>


            <td style="text-align: center;">
              <a href="<?php echo base_url(); ?>surat_masuk/update/<?php echo $key->id ?>" class="btn btn-info btn-warning btn-xs">
                <span class="glyphicon glyphicon-pencil"></span> 
              </a>
            </td>
            <td style="text-align: center;">
              <a href="<?php echo base_url(); ?>surat_masuk/delete/<?php echo $key->id ?>" class="btn btn-info btn-danger btn-xs">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="alert alert-info" id="exampleModalLabel"><h4 align="center">Data Surat Masuk</h4></div>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <form action="<?php echo base_url(); ?>surat_masuk/action_add" method="post">
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="tanggal_masuk" placeholder="Tanggal" autocomplete="off" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="penerima" placeholder="Nama Penerima Surat" autocomplete="off" required>
              </div>
              <div class="form-group">
