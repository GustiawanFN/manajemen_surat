...
<section class="content-header" style="margin-bottom:0px;background-color:#dfe1e2; padding-bottom:10px">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-address-book-o"></i> Buku Tamu</li>
  </ol>
</section>
  ...
  <table class="table table-bordered" cellspacing="0" style="margin-bottom:0px;">
    <thead>
      <tr>
        ...
        <form class="navbar-form" action="<?php echo base_url('buku_tamu/hasil')?>" role="search" style="padding-left:0px;">
      ...
      <tr style="background-color:#3c8dbc; color:white;">
        ...
        <th style="text-align: center;">Pekerjaan / Instansi</th>
        <th style="text-align: center;">Alamat</th>
        <th style="text-align: center;">Keperluan</th>
        <th style="text-align: center;">Saran dan harapan</th>
      ...
      if(count($user)>0)
      {
        foreach($user as $key){ 
          ...
          <tr style="background-color:#dfe1e2; color:black;">
           ...
           <td style="text-align: center;"><?php echo $key->nama_tamu ?></td>
           <td style="text-align: center;"><?php echo $key->pekerjaan_tamu ?></td>
           <td style="text-align: center;"><?php echo $key->alamat_tamu ?></td>
           <td style="text-align: center;"><?php echo $key->keperluan ?></td>
           <td style="text-align: center;"><?php echo $key->saran_tamu ?></td>
           
           <td style="text-align: center;">
             <a href="<?php echo base_url(); ?>buku_tamu/update/<?php echo $key->id ?>" class="btn btn-info btn-warning btn-xs">
              <span class="glyphicon glyphicon-pencil"></span> 
            </a>
          </td>
          <td style="text-align: center;">
            <a href="<?php echo base_url(); ?>buku_tamu/delete/<?php echo $key->id ?>" class="btn btn-info btn-danger btn-xs">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="alert alert-info" id="exampleModalLabel"><h3 align="center">Data Buku Tamu</h3></div>

        </div>
        <div class="modal-body">
          <div class="form-group">
            <form action="<?php echo base_url(); ?>buku_tamu/action_add" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama_tamu" placeholder="Nama" autocomplete="off" required>
            </div>

            <div class="form-group">
              <label for="exampleInputEmail1">Pekerjaan / Instansi</label>
              <input type="text" class="form-control" name="pekerjaan_tamu" placeholder="Pekerjaan" autocomplete="off" required>
            </div>

            <div class="form-group">
              <label for="exampleInputEmail1">Alamat</label>
              <input type="text" class="form-control" name="alamat_tamu" placeholder="Alamat" autocomplete="off" required>
            </div>

            <div class="form-group">
              <label for="exampleInputEmail1">Keperluan</label>
              <input type="text" class="form-control" name="keperluan" placeholder="Keperluan" autocomplete="off" required>
            </div>

            <div class="form-group">
              <label for="exampleInputEmail1">Saran dan Harapan</label>
              <input type="text" class="form-control" name="saran_tamu" placeholder="Saran" autocomplete="off" required>
            </div>
